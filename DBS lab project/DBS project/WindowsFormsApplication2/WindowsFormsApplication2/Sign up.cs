    ...
    public partial class SIGNUP : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
          ...
          foreach (char c in lnam)
          {
            ...
            {
                String oradb2 = "Data Source=DESKTOP-C9VNRJB;Persist Security Info=True;User ID=SYSTEM;Password=pogkaku";
                ...
                if (t2 == 0 && t1==0 && t3==0 && ph1!=ph2)
                {
                    ...
                    try
                    {
                        String oradb1 = "Data Source=DESKTOP-C9VNRJB;Persist Security Info=True;User ID=SYSTEM;Password=pogkaku";
                     ...
                     if (textBox1.Text.Length != 0)
                     {
                         try
                         {
                             String oradb3 = "Data Source=DESKTOP-C9VNRJB;Persist Security Info=True;User ID=SYSTEM;Password=pogkaku";
